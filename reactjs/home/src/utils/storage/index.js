...
// 생성방법 - atom(초기값)이 아니라 atom(GeTTER, SETTER) 중 필요한 걸 넣어서 처리하도록 구현
// [1] 로그인 상태를 판정하는 파생 atom (LoginUserState를 가져다가 )
export const isLoginState = atom(get=>{
    // 기존atom중에서 loginUserState를 불러온다
