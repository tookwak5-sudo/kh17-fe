...
import { S as Store } from './types-BKkMT4vU.js';
import 'jotai/react';
...
type ExtensionProps = ShellTriggerButtonProps & {
...
declare const InternalDevTools: (props: DevToolsProps) => React.ReactNode;

export { type DevToolsProps, InternalDevTools };
