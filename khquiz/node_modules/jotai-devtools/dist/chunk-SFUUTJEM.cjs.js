...
var _chunkTOJPDLRZcjsjs = require('./chunk-TOJPDLRZ.cjs.js');

// src/DevTools/DevTools.tsx
var _react = require('react'); var React38 = _interopRequireWildcard(_react); var React37 = _interopRequireWildcard(_react); var React15 = _interopRequireWildcard(_react); var React12 = _interopRequireWildcard(_react); var React3 = _interopRequireWildcard(_react); var React5 = _interopRequireWildcard(_react); var React6 = _interopRequireWildcard(_react); var React9 = _interopRequireWildcard(_react); var React8 = _interopRequireWildcard(_react); var React14 = _interopRequireWildcard(_react); var React13 = _interopRequireWildcard(_react); var React16 = _interopRequireWildcard(_react); var React18 = _interopRequireWildcard(_react); var React19 = _interopRequireWildcard(_react); var React20 = _interopRequireWildcard(_react); var React35 = _interopRequireWildcard(_react); var React28 = _interopRequireWildcard(_react);
...
// src/DevTools/atoms/devtools-options.ts
var _react2 = require('jotai/react');


// src/DevTools/internal-jotai-store.ts

var InternalDevToolsContext = _react.createContext.call(void 0, 
  void 0
);
var useInternalStore = () => {
...
var useDevtoolsJotaiStoreOptions = () => ({
  store: useInternalStore()
});

// src/DevTools/atoms/devtools-options.ts
var defaultDevToolsOptions = {
...
var internalDevToolsOptions = _vanilla.atom.call(void 0, 
  defaultDevToolsOptions
);
var devToolsOptionsAtom = _vanilla.atom.call(void 0, 
  (get) => {
...
var useSetDevToolsOptions = () => _react2.useSetAtom.call(void 0, devToolsOptionsAtom, useDevtoolsJotaiStoreOptions());
var useDevToolsOptionsValue = () => _react2.useAtomValue.call(void 0, devToolsOptionsAtom, useDevtoolsJotaiStoreOptions());
...
// src/DevTools/atoms/is-shell-open-atom.ts
var _utils = require('jotai/vanilla/utils');

// src/DevTools/utils/generate-local-storage-key.ts
var PREFIX = "jotai-devtools";
var generateLocalStorageKey = (key5, version) => {
  return `${PREFIX}-${key5}-V${version}`;
};

// src/DevTools/atoms/is-shell-open-atom.ts
var key = generateLocalStorageKey("is-shell-open", 0);
var isShellOpenAtom = _utils.atomWithStorage.call(void 0, key, null);

// src/DevTools/atoms/user-custom-store.ts


var userStore = _vanilla.atom.call(void 0, void 0);
var useUserStoreValue = () => _react2.useAtomValue.call(void 0, userStore, useDevtoolsJotaiStoreOptions());
var useSetUserStore = () => _react2.useSetAtom.call(void 0, userStore, useDevtoolsJotaiStoreOptions());

// src/DevTools/hooks/useThemeMode.tsx

var useThemeMode = (light, dark) => {
  const computedColorScheme = _core.useComputedColorScheme.call(void 0, "light", {
    getInitialValueInEffect: true
  });
  return computedColorScheme === "light" ? light : dark;
};

// src/DevTools/Extension/assets/logo.ts
var logo = `
...
// src/DevTools/atoms/shell-styles.ts


// src/DevTools/constants.ts
var shellStyleDefaults = {
  minHeight: 200,
  // in px
  maxHeight: "90%",
  defaultHeight: 370
...
// src/DevTools/atoms/shell-styles.ts
var key2 = generateLocalStorageKey("shell-height", 0);
var shellStylesAtom = _utils.atomWithStorage.call(void 0, key2, {
  height: shellStyleDefaults.defaultHeight,
  isDragging: false
});

// src/DevTools/Extension/components/Shell/atoms.ts



// src/DevTools/utils/get-type-of-atom-value.ts
var isValueAtom = (value) => {
  return typeof _optionalChain([value, 'optionalAccess', _2 => _2.read]) === "function" || typeof _optionalChain([value, 'optionalAccess', _3 => _3.write]) === "function" || !!_optionalChain([value, 'optionalAccess', _4 => _4.init]) || !!_optionalChain([value, 'optionalAccess', _5 => _5.debugLabel]);
};
...
// src/DevTools/utils/atom-to-printable.ts
var atomToPrintable = (atom8) => {
  return atom8.debugLabel ? atom8.debugLabel : `<unlabeled-${atom8}>`;
};

// src/DevTools/utils/stringify-atom-value.ts
var _javascriptstringify = require('javascript-stringify');
var stringifyWithDoubleQuotes = (value, _, stringify2) => {
  if (typeof value === "string") {
    return '"' + value.replace(/"/g, '\\"') + '"';
  }
  return stringify2(value);
};
var literalStringValues = ["bigint", "symbol", "undefined", "function"];
var ErrorSymbol = /* @__PURE__ */ Symbol("parsing-error");
var stringifyAtomValue = (atomValue) => {
  const type = getTypeOfAtomValue(atomValue);
  if (literalStringValues.includes(type)) {
    return String(atomValue);
  }
  try {
    const result = _javascriptstringify.stringify.call(void 0, atomValue, stringifyWithDoubleQuotes, 2);
...
// src/DevTools/Extension/components/Shell/atoms.ts
var selectedShellTabKey = generateLocalStorageKey("selected-shell-tab", 0);
var selectedShellTab = _utils.atomWithStorage.call(void 0, 
  selectedShellTabKey,
  "atom-viewer" /* AtomViewer */
);
var useSelectedShellTab = () => _react2.useAtom.call(void 0, selectedShellTab, useDevtoolsJotaiStoreOptions());

// src/DevTools/Extension/components/Shell/components/AtomViewer/AtomViewer.tsx


var _reactresizablepanels = require('react-resizable-panels');

// src/DevTools/Extension/components/Shell/components/PanelResizeHandle.tsx
...
var PanelResizeHandle = () => {
  return /* @__PURE__ */ React38.default.createElement(_reactresizablepanels.PanelResizeHandle, { id: "jotai-devtools-panel-resize-handle" }, /* @__PURE__ */ React38.default.createElement(
    _core.Box,
    {
      p: "5",
      className: "internal-jotai-devtools-panel-resize-handle-wrapper"
    },
    /* @__PURE__ */ React38.default.createElement(
      _core.Box,
      {
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/AtomDetail.tsx
...
// src/DevTools/atoms/values-atom.ts


var valuesAtom = _vanilla.atom.call(void 0, []);
var useSnapshotValues = () => _react2.useAtom.call(void 0, valuesAtom, useDevtoolsJotaiStoreOptions());

// src/DevTools/Extension/components/Shell/components/AtomViewer/utils/filter-atoms-by-string.ts
var filterAtomsByString = (searchString, defaultAtoms) => {
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/atoms.ts
var selectedAtomAtom = _vanilla.atom.call(void 0, 
  void 0
);
var searchInputInternalValueAtom = _vanilla.atom.call(void 0, "");
var filteredValuesAtom = _utils.atomWithDefault.call(void 0, (get) => {
...
var searchInputAtom = _vanilla.atom.call(void 0, 
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/hooks/useInternalAtomValue.ts



// src/DevTools/hooks/useUserStore.ts
var useUserStore = () => {
  const possibleUserStore = useUserStoreValue();
  const userStore2 = _chunkTOJPDLRZcjsjs.useDevToolsStore.call(void 0, 
    // This defaults to user's default store in a `provider-less` mode
    possibleUserStore ? { store: possibleUserStore } : void 0
  );
  return userStore2;
};
var useUserStoreOptions = () => {
...
var use = React38.default.use || ((promise) => {
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/hooks/useInternalAtomValue.ts
var isInternalAtomSubscribeFunction = (cb) => _optionalChain([cb, 'optionalAccess', _6 => _6.isJotaiDevTools]);
var delay = void 0;
function useInternalAtomValue(atom8) {
  const userStore2 = useUserStore();
  const internalStore = useInternalStore();
  const setSelectedAtomAtom = _react2.useSetAtom.call(void 0, 
    selectedAtomAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const [[valueFromReducer, storeFromReducer, atomFromReducer], rerender] = _react.useReducer.call(void 0, 
    (prev) => {
      const nextValue = userStore2.get(atom8);
      if (Object.is(prev[0], nextValue) && prev[1] === userStore2 && prev[2] === atom8) {
        return prev;
      }
      return [nextValue, userStore2, atom8];
    },
    void 0,
    () => [userStore2.get(atom8), userStore2, atom8]
  );
  let value = valueFromReducer;
  if (storeFromReducer !== userStore2 || atomFromReducer !== atom8) {
    rerender();
    value = userStore2.get(atom8);
  }
  _react.useEffect.call(void 0, () => {
    if (!_chunkTOJPDLRZcjsjs.isDevToolsStore.call(void 0, userStore2)) return;
    const atomSubCb = (() => {
    ...
    const devSubCb = (action) => {
      if (action.type !== "unsub") {
        return;
      }
      const activeValue = internalStore.get(selectedAtomAtom);
      if (activeValue) {
        const { l = [], t } = userStore2.getMountedAtomState(activeValue.atom) || {};
        const listenersArray = Array.from(l);
        const areAllCallbacksInternal = listenersArray.every(
          isInternalAtomSubscribeFunction
        );
        if (areAllCallbacksInternal && t && _optionalChain([t, 'optionalAccess', _7 => _7.size]) <= 1) {
          return setSelectedAtomAtom(void 0);
        }
      }
    };
    const devUnsubscribeStore = userStore2.subscribeStore(devSubCb);
    const unsub = userStore2.sub(atom8, atomSubCb);
    rerender();
    return () => {
      _optionalChain([devUnsubscribeStore, 'optionalCall', _8 => _8()]);
      unsub();
    };
  }, [userStore2, setSelectedAtomAtom, internalStore, atom8]);
...
// src/DevTools/hooks/useAtomsSnapshots.ts

var useAtomsSnapshots = () => {
  const { shouldShowPrivateAtoms } = useDevToolsOptionsValue();
  const store = useUserStore();
  const opts = { store, shouldShowPrivateAtoms };
  const currentSnapshots = _chunkTOJPDLRZcjsjs.useAtomsSnapshot.call(void 0, opts);
  return currentSnapshots;
};
var useSyncSnapshotValuesToAtom = () => {
  const currentSnapshots = useAtomsSnapshots();
  const [values, setValues] = useSnapshotValues();
  const valuesArr = _react.useMemo.call(void 0, () => {
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/AtomDependentsList.tsx
var AtomDependentsList = ({
  atom: atom8
}) => {
  const { dependents } = useAtomsSnapshots();
  const depsForAtom = React3.useMemo(() => {
    const arr = Array.from(dependents.get(atom8) || []);
    const filteredCurrentAtom = arr.filter(
      (a) => a.toString() !== atom8.toString()
    );
    return filteredCurrentAtom;
  }, [dependents, atom8]);
  const listOfDependents = React3.useMemo(
    () => depsForAtom.map((atom9, i) => {
      const parsedDebugLabel = atomToPrintable(atom9);
      return /* @__PURE__ */ React3.createElement(_core.List.Item, { key: `${i}-${atom9.toString()}-dependents-list` }, /* @__PURE__ */ React3.createElement(_core.Code, { "data-testid": `dependents-list-item-${parsedDebugLabel}-${i}` }, parsedDebugLabel));
    }),
    [depsForAtom]
  );
  return /* @__PURE__ */ React3.createElement(_core.Box, null, /* @__PURE__ */ React3.createElement(_core.Text, { fw: "bold", mb: 10, mt: 20 }, "Dependents"), listOfDependents.length ? /* @__PURE__ */ React3.createElement(_core.List, { type: "ordered", mb: 10 }, listOfDependents) : /* @__PURE__ */ React3.createElement(_core.Text, { size: "sm", mb: 10 }, "No dependents"));
};
...
// src/DevTools/Extension/components/Shell/components/MetaInfo.tsx


var MetaInfo = ({ label, value, color }) => {
  return /* @__PURE__ */ React38.default.createElement(_core.Box, { mb: 10 }, /* @__PURE__ */ React38.default.createElement(
    _core.Text,
    {
      tt: "uppercase",
      fz: 10,
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/AtomMetaDetails.tsx
var AtomMetaDetails = React5.memo(
  ({
    debugLabel,
    atomValueType,
    isAtomPrivate
    ...
    return /* @__PURE__ */ React5.createElement(_core.Box, null, /* @__PURE__ */ React5.createElement(_core.Text, { fw: "bold", mb: 10 }, "Meta"), /* @__PURE__ */ React5.createElement(MetaInfo, { label: "Debug Label", value: debugLabel }), /* @__PURE__ */ React5.createElement(MetaInfo, { label: "Value type", value: atomValueType }), isAtomPrivate && /* @__PURE__ */ React5.createElement(MetaInfo, { label: "Private", value: "Yes", color: privateColor }));
  }
);
AtomMetaDetails.displayName = "AtomMetaDetails";

// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/AtomValue.tsx



// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/createReactComponent.mjs


// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/defaultAttributes.mjs
...
var createReactComponent = (type, iconName, iconNamePascal, iconNode) => {
  const Component = _react.forwardRef.call(void 0, 
    ({ color = "currentColor", size = 24, stroke = 2, title, className, children, ...rest }, ref) => _react.createElement.call(void 0, 
      "svg",
      {
        ref,
      ...
      [
        title && _react.createElement.call(void 0, "title", { key: "svg-title" }, title),
...
// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconAlertCircle.mjs
...
// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconBinaryTree2.mjs
var __iconNode2 = [["path", { "d": "M14 6a2 2 0 1 0 -4 0a2 2 0 0 0 4 0", "key": "svg-0" }], ["path", { "d": "M7 14a2 2 0 1 0 -4 0a2 2 0 0 0 4 0", "key": "svg-1" }], ["path", { "d": "M21 14a2 2 0 1 0 -4 0a2 2 0 0 0 4 0", "key": "svg-2" }], ["path", { "d": "M14 18a2 2 0 1 0 -4 0a2 2 0 0 0 4 0", "key": "svg-3" }], ["path", { "d": "M12 8v8", "key": "svg-4" }], ["path", { "d": "M6.316 12.496l4.368 -4.992", "key": "svg-5" }], ["path", { "d": "M17.684 12.496l-4.366 -4.99", "key": "svg-6" }]];
var IconBinaryTree2 = createReactComponent("outline", "binary-tree-2", "BinaryTree2", __iconNode2);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconChevronDown.mjs
var __iconNode3 = [["path", { "d": "M6 9l6 6l6 -6", "key": "svg-0" }]];
var IconChevronDown = createReactComponent("outline", "chevron-down", "ChevronDown", __iconNode3);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconChevronLeft.mjs
var __iconNode4 = [["path", { "d": "M15 6l-6 6l6 6", "key": "svg-0" }]];
var IconChevronLeft = createReactComponent("outline", "chevron-left", "ChevronLeft", __iconNode4);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconChevronRight.mjs
var __iconNode5 = [["path", { "d": "M9 6l6 6l-6 6", "key": "svg-0" }]];
var IconChevronRight = createReactComponent("outline", "chevron-right", "ChevronRight", __iconNode5);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconChevronUp.mjs
var __iconNode6 = [["path", { "d": "M6 15l6 -6l6 6", "key": "svg-0" }]];
var IconChevronUp = createReactComponent("outline", "chevron-up", "ChevronUp", __iconNode6);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconCircleCheck.mjs
var __iconNode7 = [["path", { "d": "M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0", "key": "svg-0" }], ["path", { "d": "M9 12l2 2l4 -4", "key": "svg-1" }]];
var IconCircleCheck = createReactComponent("outline", "circle-check", "CircleCheck", __iconNode7);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconFileCode.mjs
var __iconNode8 = [["path", { "d": "M14 3v4a1 1 0 0 0 1 1h4", "key": "svg-0" }], ["path", { "d": "M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2", "key": "svg-1" }], ["path", { "d": "M10 13l-1 2l1 2", "key": "svg-2" }], ["path", { "d": "M14 13l1 2l-1 2", "key": "svg-3" }]];
var IconFileCode = createReactComponent("outline", "file-code", "FileCode", __iconNode8);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconFileDiff.mjs
var __iconNode9 = [["path", { "d": "M14 3v4a1 1 0 0 0 1 1h4", "key": "svg-0" }], ["path", { "d": "M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2", "key": "svg-1" }], ["path", { "d": "M12 10l0 4", "key": "svg-2" }], ["path", { "d": "M10 12l4 0", "key": "svg-3" }], ["path", { "d": "M10 17l4 0", "key": "svg-4" }]];
var IconFileDiff = createReactComponent("outline", "file-diff", "FileDiff", __iconNode9);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconLayoutList.mjs
var __iconNode10 = [["path", { "d": "M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -2", "key": "svg-0" }], ["path", { "d": "M4 16a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -2", "key": "svg-1" }]];
var IconLayoutList = createReactComponent("outline", "layout-list", "LayoutList", __iconNode10);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconMinus.mjs
var __iconNode11 = [["path", { "d": "M5 12l14 0", "key": "svg-0" }]];
var IconMinus = createReactComponent("outline", "minus", "Minus", __iconNode11);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconMoonStars.mjs
var __iconNode12 = [["path", { "d": "M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454l0 .008", "key": "svg-0" }], ["path", { "d": "M17 4a2 2 0 0 0 2 2a2 2 0 0 0 -2 2a2 2 0 0 0 -2 -2a2 2 0 0 0 2 -2", "key": "svg-1" }], ["path", { "d": "M19 11h2m-1 -1v2", "key": "svg-2" }]];
var IconMoonStars = createReactComponent("outline", "moon-stars", "MoonStars", __iconNode12);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconRotate2.mjs
var __iconNode13 = [["path", { "d": "M15 4.55a8 8 0 0 0 -6 14.9m0 -4.45v5h-5", "key": "svg-0" }], ["path", { "d": "M18.37 7.16l0 .01", "key": "svg-1" }], ["path", { "d": "M13 19.94l0 .01", "key": "svg-2" }], ["path", { "d": "M16.84 18.37l0 .01", "key": "svg-3" }], ["path", { "d": "M19.37 15.1l0 .01", "key": "svg-4" }], ["path", { "d": "M19.94 11l0 .01", "key": "svg-5" }]];
var IconRotate2 = createReactComponent("outline", "rotate-2", "Rotate2", __iconNode13);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconSourceCode.mjs
var __iconNode14 = [["path", { "d": "M14.5 4h2.5a3 3 0 0 1 3 3v10a3 3 0 0 1 -3 3h-10a3 3 0 0 1 -3 -3v-5", "key": "svg-0" }], ["path", { "d": "M6 5l-2 2l2 2", "key": "svg-1" }], ["path", { "d": "M10 9l2 -2l-2 -2", "key": "svg-2" }]];
var IconSourceCode = createReactComponent("outline", "source-code", "SourceCode", __iconNode14);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconSun.mjs
...
// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconTimeline.mjs
var __iconNode16 = [["path", { "d": "M4 16l6 -7l5 5l5 -6", "key": "svg-0" }], ["path", { "d": "M14 14a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-1" }], ["path", { "d": "M9 9a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-2" }], ["path", { "d": "M3 16a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-3" }], ["path", { "d": "M19 8a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-4" }]];
var IconTimeline = createReactComponent("outline", "timeline", "Timeline", __iconNode16);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconTrashX.mjs
var __iconNode17 = [["path", { "d": "M4 7h16", "key": "svg-0" }], ["path", { "d": "M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12", "key": "svg-1" }], ["path", { "d": "M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3", "key": "svg-2" }], ["path", { "d": "M10 12l4 4m0 -4l-4 4", "key": "svg-3" }]];
var IconTrashX = createReactComponent("outline", "trash-x", "TrashX", __iconNode17);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconPlayerPauseFilled.mjs
var __iconNode18 = [["path", { "d": "M9 4h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h2a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2z", "key": "svg-0" }], ["path", { "d": "M17 4h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h2a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2z", "key": "svg-1" }]];
var IconPlayerPauseFilled = createReactComponent("filled", "player-pause-filled", "PlayerPauseFilled", __iconNode18);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconPlayerPlayFilled.mjs
var __iconNode19 = [["path", { "d": "M6 4v16a1 1 0 0 0 1.524 .852l13 -8a1 1 0 0 0 0 -1.704l-13 -8a1 1 0 0 0 -1.524 .852z", "key": "svg-0" }]];
var IconPlayerPlayFilled = createReactComponent("filled", "player-play-filled", "PlayerPlayFilled", __iconNode19);

// node_modules/.pnpm/@tabler+icons-react@3.42.0_react@18.3.1/node_modules/@tabler/icons-react/dist/esm/icons/IconPlayerRecordFilled.mjs
var __iconNode20 = [["path", { "d": "M8 5.072a8 8 0 1 1 -3.995 7.213l-.005 -.285l.005 -.285a8 8 0 0 1 3.995 -6.643z", "key": "svg-0" }]];
var IconPlayerRecordFilled = createReactComponent("filled", "player-record-filled", "PlayerRecordFilled", __iconNode20);

// src/DevTools/Extension/components/Shell/components/ErrorMessage.tsx
...
var ErrorMessage = ({ message }) => {
  ...
  return /* @__PURE__ */ React6.createElement(_core.Text, { size: "sm", fw: "500", color: themedRedColor, style: textStyles }, /* @__PURE__ */ React6.createElement(_core.Text, { component: "span", mr: 5, style: textStyles }, /* @__PURE__ */ React6.createElement(IconAlertCircle, { size: 16 })), message);
};

// src/DevTools/Extension/components/Shell/components/JSONTree/JSONTree.tsx


var _reactjsontree = require('react-json-tree');

// src/DevTools/Extension/components/Shell/components/JSONTree/utils/get-item-string.ts
...
var getItemStringWithDiff = (nodeType, data, isForDiff) => {
  ...
  if (nodeType === "Object") {
    ...
    const str = keys.slice(0, 3).map(
      (key5) => `${key5}: ${getShortTypeString(data[key5], isForDiff)}`
    ).concat(keys.length > 3 ? ["\u2026"] : []).join(", ");
    return `{ ${str} }`;
  }
  if (nodeType === "Array") {
    if (!previewContent) return data.length ? "[\u2026]" : "[]";
    const str = data.slice(0, 4).map((val) => getShortTypeString(val), isForDiff).concat(data.length > 3 ? ["\u2026"] : []).join(", ");
    return `[${str}]`;
  }
  return nodeType;
};
var getItemString = (nodeType, data) => getItemStringWithDiff(nodeType, data, false);
var getItemStringWithDiffEnabled = (nodeType, data) => getItemStringWithDiff(nodeType, data, true);

// src/DevTools/Extension/components/Shell/components/JSONTree/utils/use-JSON-tree-styling.ts
...
// src/DevTools/Extension/components/Shell/components/JSONTree/utils/get-json-tree-theme.ts
...
// src/DevTools/Extension/components/Shell/components/JSONTree/utils/use-JSON-tree-styling.ts
var createJSONTreeTheme = (theme2) => {
  const light = {
    scheme: "Jotai DevTools Light",
    author: "Jotai DevTools",
    base00: _core.rgba.call(void 0, theme2.colors.gray[0], 0.65),
    base01: "#ffffff",
    // ?? unused
    base02: "#ffffff",
    // ?? unused
    base03: theme2.colors.dark[2],
    // expanded string
    base04: "#ffffff",
    // ?? unused
    base05: "#ffffff",
    // ?? unused
    base06: _core.rgba.call(void 0, theme2.colors.green[8], 0.65),
    // reserved for diff add
    base07: _core.rgba.call(void 0, theme2.colors.red[8], 0.65),
    // reserved for diff remove
    base08: "#ffffff",
    // ?? unused
    base09: theme2.colors.blue[8],
    // boolean, symbol, numbers, constants
    base0A: theme2.colors.violet[9],
    // function
    base0B: theme2.colors.teal[8],
    // string, date
    base0C: "#ffffff",
    // ?? unused
    base0D: theme2.colors.gray[8],
  ...
  const dark = {
    ...
    author: "Jotai DevTools",
    base00: theme2.colors.dark[8],
    base01: "#ffffff",
    // ?? unused
    base02: "#ffffff",
    // ?? unused
    base03: theme2.colors.dark[3],
    // expanded string
    base04: "#ffffff",
    // ?? unused
    base05: "#ffffff",
    // ?? unused
    base06: _core.rgba.call(void 0, theme2.colors.green[7], 0.65),
    // reserved for diff add
    base07: _core.rgba.call(void 0, theme2.colors.red[7], 0.65),
    // reserved for diff remove
    base08: "#ffffff",
    // ?? unused
    base09: theme2.colors.blue[4],
    // boolean, symbol, numbers, constants
    base0A: theme2.colors.violet[4],
    // function
    base0B: theme2.colors.teal[4],
    // string, date
    base0C: "#ffffff",
    // ?? unused
    base0D: theme2.colors.gray[4],
    // label and arrow color
    base0E: "#ffffff",
    // ?? unused
    base0F: "#ffffff"
...
var useCreateJSONTreeBase16Theme = () => {
  const theme2 = _core.useMantineTheme.call(void 0, );
  const { colorScheme: mantineColorScheme } = _core.useMantineColorScheme.call(void 0, );
  const colorScheme = mantineColorScheme === "auto" ? "dark" : mantineColorScheme;
  const base16Theme = createJSONTreeTheme(theme2)[colorScheme];
  return base16Theme;
};
var useJSONTreeStyling = () => {
  const base16Theme = useCreateJSONTreeBase16Theme();
  const createStylingFromTheme = _reactbase16styling.createStyling.call(void 0, getJsonTreeTheme, {
    defaultBase16: base16Theme
  });
  const styling = createStylingFromTheme(base16Theme);
  return { theme: getJsonTreeTheme(base16Theme), styling };
};

// src/DevTools/Extension/components/Shell/components/JSONTree/JSONTree.tsx
var defaultValueRenderer = (_, value) => {
...
var JSONTree = (props) => {
  ...
  const memoizedShouldExpandNodeInitially = _react.useCallback.call(void 0, 
    () => !!shouldExpandJsonTreeViewInitially,
    [shouldExpandJsonTreeViewInitially]
  );
  return /* @__PURE__ */ React38.default.createElement(
    _core.Box,
    {
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/atoms.ts


var key3 = generateLocalStorageKey("atom-value-viewer", 0);
var atomValueViewer = _utils.atomWithStorage.call(void 0, 
  key3,
  "raw-value"
);
var useAtomValueViewer = () => _react2.useAtom.call(void 0, atomValueViewer, useDevtoolsJotaiStoreOptions());

// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/MemoizedValueRenderer.tsx


// src/DevTools/Extension/components/Shell/components/CodeSyntaxHighlighter.tsx

var _codehighlight = require('@mantine/code-highlight');
...
// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/MemoizedValueRenderer.tsx
var MemoizedValueRenderer = React9.memo(
  ({ value }) => {
...
var AtomValue = ({
  ...
  const [atomValueViewer2, setSelectedValueViewer] = useAtomValueViewer();
  const parsedValue = stringifyAtomValue(atomValue);
  const handleOnTabChange = _react.useCallback.call(void 0, 
    (value) => {
      if (value) {
        setSelectedValueViewer(value);
      }
    },
    [setSelectedValueViewer]
  );
  if (parsedValue === ErrorSymbol) {
    return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Text, { fw: "bold", mb: "sm" }, "Raw value"), /* @__PURE__ */ React38.default.createElement(ErrorMessage, { message: "Failed to parse the value of the atom" }));
  }
  ...
  if (!isJsonTreeCompatible) {
    return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Text, { fw: "bold", mb: "sm" }, "Raw value"), /* @__PURE__ */ React38.default.createElement(MemoizedValueRenderer, { value: parsedValue }));
  }
  return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Text, { fw: "bold", mb: "sm" }, "Value"), /* @__PURE__ */ React38.default.createElement(
    _core.Tabs,
    {
    ...
    /* @__PURE__ */ React38.default.createElement(_core.Tabs.List, null, /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Tab,
      {
        value: "raw-value",
        leftSection: /* @__PURE__ */ React38.default.createElement(IconSourceCode, { size: "0.9rem", stroke: "1.75" })
      },
      "Raw value"
    ), /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Tab,
      {
        value: "json-tree",
        leftSection: /* @__PURE__ */ React38.default.createElement(IconBinaryTree2, { size: "0.9rem", stroke: "1.75" })
      },
      "Tree view"
    )),
    /* @__PURE__ */ React38.default.createElement(_core.Tabs.Panel, { value: "raw-value", pt: "xs" }, /* @__PURE__ */ React38.default.createElement(MemoizedValueRenderer, { value: parsedValue })),
    /* @__PURE__ */ React38.default.createElement(_core.Tabs.Panel, { value: "json-tree", pt: "xs", "data-testid": "json-tree-panel" }, /* @__PURE__ */ React38.default.createElement(JSONTree, { data: atomValue }))
  ));
};

// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/components/DisplayAtomDetails.tsx
var DisplayAtomDetails = ({ atom: atom8 }) => {
  const atomValue = useInternalAtomValue(atom8);
  const atomValueType = getTypeOfAtomValue(atomValue);
  return /* @__PURE__ */ React38.default.createElement(_core.Stack, { h: "auto" }, /* @__PURE__ */ React38.default.createElement(_core.Title, { size: "h3" }, "Atom Details"), /* @__PURE__ */ React38.default.createElement(
    AtomMetaDetails,
    {
      debugLabel: atomToPrintable(atom8),
      atomValueType,
      isAtomPrivate: _optionalChain([atom8, 'optionalAccess', _9 => _9.debugPrivate])
    }
  ), /* @__PURE__ */ React38.default.createElement(AtomValue, { atomValue }), /* @__PURE__ */ React38.default.createElement(AtomDependentsList, { atom: atom8 }));
};

// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomDetail/AtomDetail.tsx
var messageBoxWrapperStyles = {
  position: "relative",
  top: "50%",
  transform: "translateY(-50%)"
};
var loadingOverlayOverlayProps = {
  blur: 2,
  backgroundOpacity: 0
};
var AtomDetail = React12.memo(() => {
  const selectedAtomData = _react2.useAtomValue.call(void 0, 
    selectedAtomAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const loaderProps = {
  ...
  if (!selectedAtomData) {
    return /* @__PURE__ */ React12.createElement(_core.Box, { style: messageBoxWrapperStyles }, /* @__PURE__ */ React12.createElement(_core.Text, { w: "100%", ta: "center" }, "Select an atom from the left panel to view the details", " "));
  }
  return /* @__PURE__ */ React12.createElement(
    React12.Suspense,
    {
      fallback: /* @__PURE__ */ React12.createElement(
        _core.LoadingOverlay,
        {
          visible: true,
    ...
    /* @__PURE__ */ React12.createElement(DisplayAtomDetails, { atom: selectedAtomData.atom })
  );
});
AtomDetail.displayName = "AtomDetail";

// src/DevTools/Extension/components/Shell/components/AtomViewer/components/AtomList/AtomList.tsx




// src/DevTools/Extension/components/Shell/components/ActionListItem.tsx


var ActionListItem = React13.memo(
  React13.forwardRef(
    ({ label, onClick, id, isActive, ...rest }, ref) => {
      const handleOnClick = React13.useCallback(() => onClick(id), [onClick, id]);
      return /* @__PURE__ */ React13.createElement(
        _core.NavLink,
        {
          ...
          label: React13.useMemo(
            () => /* @__PURE__ */ React13.createElement(_core.Text, { className: "internal-jotai-devtools-monospace-font" }, label),
            [label]
          ),
          variant: "filled",
          ...
          rightSection: React13.useMemo(
            () => /* @__PURE__ */ React13.createElement(IconChevronRight, { size: 12, stroke: 1.5 }),
            []
          )
        }
      );
...
var SearchAtoms = React14.memo(() => {
  const [userInput, setUserInput] = _react2.useAtom.call(void 0, 
    searchInputAtom,
    useDevtoolsJotaiStoreOptions()
  );
...
var atomItemsWrapperStyle = { overflow: "auto" };
var AtomList = () => {
  useSyncSnapshotValuesToAtom();
  const values = _react2.useAtomValue.call(void 0, 
    filteredValuesAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const [selectedAtomData, setSelectedAtomAtom] = _react2.useAtom.call(void 0, 
    selectedAtomAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const valuesRef = React14.useRef(values);
  React14.useEffect(() => {
  ...
  const handleOnClick = React14.useCallback(
    (pos) => {
      ...
      setSelectedAtomAtom((currValue) => {
        const foundAtom = _optionalChain([valuesRef, 'access', _10 => _10.current, 'access', _11 => _11[pos], 'optionalAccess', _12 => _12[0]]);
        if (!foundAtom || _optionalChain([currValue, 'optionalAccess', _13 => _13.atomKey]) === _optionalChain([foundAtom, 'optionalAccess', _14 => _14.toString, 'call', _15 => _15()])) {
          return void 0;
        }
        return { atomKey: _optionalChain([foundAtom, 'optionalAccess', _16 => _16.toString, 'call', _17 => _17()]), atom: foundAtom };
      });
    },
    [setSelectedAtomAtom]
  );
  const atomItems = React14.useMemo(
    () => values.map(([atom8], i) => {
      ...
      return /* @__PURE__ */ React14.createElement(
        ActionListItem,
        {
          ...
          onClick: handleOnClick,
          id: i,
          isActive: _optionalChain([selectedAtomData, 'optionalAccess', _18 => _18.atomKey]) === atomKey
        }
      );
    }),
  ...
  return /* @__PURE__ */ React14.createElement(React14.Fragment, null, /* @__PURE__ */ React14.createElement(SearchAtoms, null), /* @__PURE__ */ React14.createElement(_core.Box, { style: atomItemsWrapperStyle }, atomItems), noResultsFound && /* @__PURE__ */ React14.createElement(_core.Group, { mt: 20, justify: "center", gap: 6 }, /* @__PURE__ */ React14.createElement(IconAlertCircle, { size: 16 }), /* @__PURE__ */ React14.createElement(_core.Text, { fz: "sm", ml: 0, "data-testid": "atom-list-no-atoms-found-message" }, "No Atoms found!")));
};

// src/DevTools/Extension/components/Shell/components/AtomViewer/AtomViewer.tsx
var panelStyles = { overflow: "auto" };
var AtomViewer = React15.memo(() => {
  return /* @__PURE__ */ React15.createElement(_reactresizablepanels.PanelGroup, { direction: "horizontal" }, /* @__PURE__ */ React15.createElement(_reactresizablepanels.Panel, { defaultSize: 50, minSize: 30, style: panelStyles }, /* @__PURE__ */ React15.createElement(
    _core.Flex,
    {
      p: 10,
      pt: 0,
    ...
    /* @__PURE__ */ React15.createElement(AtomList, null)
  )), /* @__PURE__ */ React15.createElement(PanelResizeHandle, null), /* @__PURE__ */ React15.createElement(_reactresizablepanels.Panel, { defaultSize: 50, minSize: 30, style: panelStyles }, /* @__PURE__ */ React15.createElement(_core.Flex, { p: 10, pl: 0, h: "100%", direction: "column", pos: "relative" }, /* @__PURE__ */ React15.createElement(AtomDetail, null))));
});

// src/DevTools/Extension/components/Shell/components/ErrorBoundary.tsx
...
var ErrorFallback = ({ error }) => {
  if (_optionalChain([Error, 'optionalAccess', _19 => _19.stackTraceLimit])) {
    Error.stackTraceLimit = 5;
  }
  _optionalChain([Error, 'optionalAccess', _20 => _20.captureStackTrace, 'optionalCall', _21 => _21(error)]);
  const themedRedColor = useThemeMode("red.8", "red.5");
  return /* @__PURE__ */ React16.createElement(
    ...
    /* @__PURE__ */ React16.createElement(_core.Box, { w: "100%", maw: "80%", mah: "80%" }, /* @__PURE__ */ React16.createElement(_core.Text, { size: "md", fw: "500", c: themedRedColor, style: textStyles3, mb: 5 }, /* @__PURE__ */ React16.createElement(_core.Text, { mr: 5, style: textStyles3 }, /* @__PURE__ */ React16.createElement(IconAlertCircle, { size: 16 })), "Uh-oh, something went wrong."), /* @__PURE__ */ React16.createElement(_core.Text, { size: "sm", c: themedRedColor, mb: "sm" }, "If you believe this to be a bug, please file an issue on", " ", /* @__PURE__ */ React16.createElement(
      _core.Anchor,
      {
    ...
    ), " ", "with a minimal reproduction and the following error"), /* @__PURE__ */ React16.createElement(CodeSyntaxHighlighter, { language: "javascript" }, _optionalChain([error, 'access', _22 => _22.stack, 'optionalAccess', _23 => _23.toString, 'call', _24 => _24()]) || error.message))
  );
};
var ErrorBoundary = ({ children }) => {
  return /* @__PURE__ */ React16.createElement(_reacterrorboundary.ErrorBoundary, { FallbackComponent: ErrorFallback }, children);
};

// src/DevTools/Extension/components/Shell/components/Header/Header.tsx
...
// src/DevTools/Extension/components/Shell/components/Header/components/ThemeToggle.tsx


var ThemeToggle = () => {
  const { colorScheme, toggleColorScheme } = _core.useMantineColorScheme.call(void 0, );
  ...
  return /* @__PURE__ */ React38.default.createElement(
    ...
    dark ? /* @__PURE__ */ React38.default.createElement(IconSun, { size: 16 }) : /* @__PURE__ */ React38.default.createElement(IconMoonStars, { size: 16 })
  );
};
...
var logoStyles = { userSelect: "none" };
var Header = React18.memo(() => {
  const setIsShellOpen = _react2.useSetAtom.call(void 0, 
    isShellOpenAtom,
    useDevtoolsJotaiStoreOptions()
  );
  return /* @__PURE__ */ React18.createElement(_core.Box, { style: headerStyles }, /* @__PURE__ */ React18.createElement(_core.Flex, { justify: "space-between", align: "center", p: 10 }, /* @__PURE__ */ React18.createElement(_core.Group, { mr: 10 }, /* @__PURE__ */ React18.createElement(_core.Title, { size: "h4", style: logoStyles }, "\u{1F47B}\xA0J\u014Dtai DevTools"), /* @__PURE__ */ React18.createElement(_core.Badge, { color: "orange", variant: "light", size: "xs" }, "Alpha")), /* @__PURE__ */ React18.createElement(_core.Flex, { align: "center" }, /* @__PURE__ */ React18.createElement(ThemeToggle, null), /* @__PURE__ */ React18.createElement(
    _core.ActionIcon,
    {
      ml: 10,
      variant: "subtle",
    ...
    /* @__PURE__ */ React18.createElement(IconMinus, { size: 16 })
  ))));
});
Header.displayName = "Header";

// src/DevTools/Extension/components/Shell/components/ShellResizeBar.tsx



var shellResizeBarStyles = {
  width: "100%",
  height: 5,
  cursor: "row-resize",
  zIndex: 2,
...
var ShellResizeBar = ({ shellRef }) => {
  const setShellStyle = _react2.useSetAtom.call(void 0, 
    shellStylesAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const handleMouseDown = (mouseDownEvent) => {
    const startY = mouseDownEvent.clientY;
    const { height = 500 } = _optionalChain([shellRef, 'optionalAccess', _25 => _25.current, 'optionalAccess', _26 => _26.getBoundingClientRect, 'call', _27 => _27()]) || {};
...
// src/DevTools/Extension/components/Shell/components/TabsHeader.tsx



// src/DevTools/Extension/components/Shell/components/TimeTravel/atoms.ts
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/utils/filter-snapshot-history-by-string.ts
var filterSnapshotHistoryByString = (searchString, defaultSnapshots) => {
  const normalizedStr = searchString.trim().toLocaleLowerCase();
  if (!normalizedStr) {
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/utils/find-snapshot-by-id.ts
var findSnapshotById = (snapshots, id) => {
  return snapshots.find((snapshot) => snapshot.id === id);
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/atoms.ts
var snapshotHistoryAtom = _vanilla.atom.call(void 0, []);
var useSetSnapshotHistory = () => _react2.useSetAtom.call(void 0, snapshotHistoryAtom, useDevtoolsJotaiStoreOptions());
var shouldRecordSnapshotHistoryKey = generateLocalStorageKey(
  "should-record-snapshot-history",
  0
);
var shouldRecordSnapshotHistoryAtom = _utils.atomWithStorage.call(void 0, 
  shouldRecordSnapshotHistoryKey,
  false
);
var useShouldRecordSnapshotHistoryValue = () => _react2.useAtomValue.call(void 0, shouldRecordSnapshotHistoryAtom, useDevtoolsJotaiStoreOptions());
var useShouldRecordSnapshotHistory = () => _react2.useAtom.call(void 0, shouldRecordSnapshotHistoryAtom, useDevtoolsJotaiStoreOptions());
var selectedSnapshotIdHolderAtom = _vanilla.atom.call(void 0, void 0);
var selectedSnapshotIdAtom = _vanilla.atom.call(void 0, 
  (get) => {
    ...
    if (snapshotHistory && selectedSnapshotId) {
      ...
      return _optionalChain([findSnapshotByIdResult, 'optionalAccess', _28 => _28.id]) && !findSnapshotByIdResult.isHidden ? findSnapshotByIdResult.id : void 0;
    }
    return void 0;
  },
  (_, set, nextId) => {
...
var useSelectedSnapshotIdValue = () => _react2.useAtomValue.call(void 0, selectedSnapshotIdAtom, useDevtoolsJotaiStoreOptions());
var useSetSelectedSnapshotId = () => _react2.useSetAtom.call(void 0, selectedSnapshotIdAtom, useDevtoolsJotaiStoreOptions());
var searchInputInternalValueAtom2 = _vanilla.atom.call(void 0, "");
var filteredSnapshotHistoryAtom = _utils.atomWithDefault.call(void 0, 
  (get) => {
...
var useSnapshotSearchInput = () => _react2.useAtom.call(void 0, searchInputInternalValueAtom2, useDevtoolsJotaiStoreOptions());
var useSnapshotSearchInputValue = () => _react2.useAtomValue.call(void 0, searchInputInternalValueAtom2, useDevtoolsJotaiStoreOptions());
var useFilteredSnapshotHistoryAtomValue = () => _react2.useAtomValue.call(void 0, filteredSnapshotHistoryAtom, useDevtoolsJotaiStoreOptions());
var shouldAutoScrollAtom = _vanilla.atom.call(void 0, 
  false
);
var useShouldAutoScroll = () => _react2.useAtom.call(void 0, shouldAutoScrollAtom, useDevtoolsJotaiStoreOptions());
var isTimeTravelingAtom = _vanilla.atom.call(void 0, false);
var useIsTimeTraveling = () => _react2.useAtom.call(void 0, isTimeTravelingAtom, useDevtoolsJotaiStoreOptions());
var getStepFromArrayLength = (arrayLength) => {
  const START = 0;
  const END = 100;
...
var snapshotSliderCurrentStepValueHolderAtom = _vanilla.atom.call(void 0, 0);
var snapshotSliderCurrentStepAtom = _vanilla.atom.call(void 0, 
...
var snapshotSliderAtom = _vanilla.atom.call(void 0, 
  (get) => {
...
var useSnapshotSliderValue = () => _react2.useAtomValue.call(void 0, snapshotSliderAtom, useDevtoolsJotaiStoreOptions());
var manualTimeTravelAtom = _vanilla.atom.call(void 0, 
  (get) => {
...
var useTimeTravelNavigateActions = () => {
  const [{ prev, next, initial }, setSliderValueRaw] = _react2.useAtom.call(void 0, 
    manualTimeTravelAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const gotoAtomsSnapshot = _chunkTOJPDLRZcjsjs.useGotoAtomsSnapshot.call(void 0, useUserStoreOptions());
  const setSliderValue = _react.useCallback.call(void 0, 
    (nextStep) => {
  ...
  const onPrevClick = _react.useCallback.call(void 0, () => {
    if (isSlidePossible) {
      setSliderValue(prev.value);
    }
  }, [prev, isSlidePossible, setSliderValue]);
  const onNextClick = _react.useCallback.call(void 0, () => {
    if (isSlidePossible) {
...
var calculatePlaybackInterval = (distance, speed) => distance / speed;
...
var playbackSpeedKey = generateLocalStorageKey("playback-speed", 0);
var playbackSpeedOptionInternalAtom = _utils.atomWithStorage.call(void 0, playbackSpeedKey, "1x");
var usePlaybackSpeedOption = () => _react2.useAtom.call(void 0, playbackSpeedOptionInternalAtom, useDevtoolsJotaiStoreOptions());
var usePlaybackSpeedOptionValue = () => _react2.useAtomValue.call(void 0, playbackSpeedOptionInternalAtom, useDevtoolsJotaiStoreOptions());
var usePlaybackSpeed = () => {
...
var useIntervalNavigation = (enabled, cb) => {
  const playbackSpeed = usePlaybackSpeed();
  const interval = _hooks.useInterval.call(void 0, cb, playbackSpeed);
  _react.useEffect.call(void 0, () => {
    if (enabled) {
      interval.start();
    }
...
var useTimeTravel = () => {
  ...
  const triggerReset = _react.useCallback.call(void 0, () => {
  ...
  const onTimeTravelToggle = _react.useCallback.call(void 0, () => {
...
// src/DevTools/Extension/components/Shell/components/TabsHeader.tsx
var TabsHeader = React20.memo(() => {
  const isSnapshotRecordingOn = useShouldRecordSnapshotHistoryValue();
  return /* @__PURE__ */ React20.createElement(_core.Tabs.List, null, /* @__PURE__ */ React20.createElement(
    _core.Tabs.Tab,
    {
      value: "atom-viewer" /* AtomViewer */,
      leftSection: /* @__PURE__ */ React20.createElement(IconLayoutList, { size: 14 })
    },
    "Atom Viewer"
  ), /* @__PURE__ */ React20.createElement(
    _core.Tabs.Tab,
    {
      value: "time-travel" /* TimeTravel */,
      leftSection: /* @__PURE__ */ React20.createElement(IconTimeline, { size: 14 }),
      pr: isSnapshotRecordingOn ? "xl" : "md"
    },
    isSnapshotRecordingOn ? /* @__PURE__ */ React20.createElement(
      _core.Indicator,
      {
        withBorder: true,
        inline: true,
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/TimeTravel.tsx




// src/DevTools/Extension/components/Shell/components/TimeTravel/components/PlayBar.tsx



// src/DevTools/Extension/components/Shell/components/TimeTravel/components/PlaybackSpeedDropdown.tsx


var options = Object.keys(
  defaultPlaybackOptions
);
var isValidPlaybackOption = (value) => {
  return options.includes(value);
};
var PlaybackSpeedDropdown = () => {
  const [value, setOption] = usePlaybackSpeedOption();
  const handleOnChange = (value2) => {
    if (value2 === null) {
      return;
    }
    if (isValidPlaybackOption(value2)) {
      return setOption(value2);
    }
    throw new Error(`[jotai-devtools]: invalid playback option: ${value2}`);
  };
  return /* @__PURE__ */ React38.default.createElement(
    _core.Select,
    {
...
var PlayBar = () => {
  ...
  const handleOnSliderChange = (value2) => {
    setSliderValue(value2);
  };
  const isDisabled = !isSlidePossible;
  return /* @__PURE__ */ React38.default.createElement(_core.Box, { className: "internal-jotai-devtools-playbar-wrapper" }, /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "filled",
      color: useThemeMode("dark", "gray"),
    ...
    isTimeTraveling ? /* @__PURE__ */ React38.default.createElement(IconPlayerPauseFilled, { size: 16 }) : /* @__PURE__ */ React38.default.createElement(IconPlayerPlayFilled, { size: 16 })
  ), /* @__PURE__ */ React38.default.createElement(
    _core.Slider,
    {
      value,
  ...
  ), /* @__PURE__ */ React38.default.createElement(_core.Group, null, /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "default",
      color: useThemeMode("dark", "gray"),
    ...
    /* @__PURE__ */ React38.default.createElement(IconChevronLeft, { size: 16 })
  ), /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "default",
    ...
    /* @__PURE__ */ React38.default.createElement(IconChevronRight, { size: 16 })
  )), /* @__PURE__ */ React38.default.createElement(PlaybackSpeedDropdown, null));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/SnapshotDetail.tsx
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/atoms.ts



// src/DevTools/Extension/components/Shell/components/TimeTravel/utils/create-diff-patcher.ts
var _jsondiffpatch = require('jsondiffpatch');
var defaultObjectHash = (o, idx) => o === null && "$$null" || o && (o.id || o.id === 0) && `$$id:${JSON.stringify(o.id)}` || o && (o._id || o._id === 0) && `$$_id:${JSON.stringify(o._id)}` || `$$index:${idx}`;
var defaultPropertyFilter = (name, context) => typeof context.left[name] !== "function" && typeof context.right[name] !== "function";
var defaultDiffPatcher = new (0, _jsondiffpatch.DiffPatcher)({
...
function createDiffPatcher(objectHash, propertyFilter) {
  ...
  return new (0, _jsondiffpatch.DiffPatcher)({
    arrays: { detectMove: false },
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/atoms.ts
var STATES_EQUAL_SYMBOL = /* @__PURE__ */ Symbol("STATES_EQUAL_SYMBOL");
var selectedSnapshotDetailAtom = _vanilla.atom.call(void 0, (get) => {
  const selectedSnapshotId = get(selectedSnapshotIdAtom);
  const snapshotHistory = get(snapshotHistoryAtom);
  if (snapshotHistory.length) {
    const selectedSnapshotIdx = selectedSnapshotId ? snapshotHistory.findIndex(
      (snapshot) => snapshot.id === selectedSnapshotId
    ) : snapshotHistory.length - 1;
    if (selectedSnapshotIdx >= 0) {
      const fromState = snapshotHistory[selectedSnapshotIdx > 0 ? selectedSnapshotIdx - 1 : 0];
      ...
      if (fromState && toState) {
        ...
        return {
          ...
          diff,
          isRestorable: diff !== STATES_EQUAL_SYMBOL && selectedSnapshotIdx !== snapshotHistory.length - 1,
...
var useSelectedSnapshotDetailValue = () => _react2.useAtomValue.call(void 0, selectedSnapshotDetailAtom, useDevtoolsJotaiStoreOptions());

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/DisplaySnapshotDetails.tsx
...
var SnapshotActions = (props) => {
  const [justRestored, setJustRestored] = _react.useState.call(void 0, false);
  const gotoSnapshot = _chunkTOJPDLRZcjsjs.useGotoAtomsSnapshot.call(void 0, useUserStoreOptions());
  const [isTimeTraveling, setIsTimeTraveling] = useIsTimeTraveling();
  const { start, clear } = _hooks.useTimeout.call(void 0, () => setJustRestored(false), 1750);
  _react.useEffect.call(void 0, () => {
    return clear;
  }, [clear]);
  ...
  return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Title, { size: "h5", mb: 10 }, "Actions"), /* @__PURE__ */ React38.default.createElement(
    _core.Button,
    {
      ...
      leftSection: justRestored ? /* @__PURE__ */ React38.default.createElement(IconCircleCheck, { size: "0.8rem" }) : /* @__PURE__ */ React38.default.createElement(IconRotate2, { size: "0.8rem" }),
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/components/SnapshotMetaDetails.tsx


var SnapshotMetaDetails = (props) => {
  return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Title, { size: "h5", mb: 10 }, "Meta"), /* @__PURE__ */ React38.default.createElement(MetaInfo, { label: "Timestamp", value: props.timestamp }));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/components/SnapshotValue.tsx



// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/atoms.ts
var _jotai = require('jotai');

var key4 = generateLocalStorageKey("snapshot-value-viewer", 0);
var snapshotValueViewer = _utils.atomWithStorage.call(void 0, 
  key4,
  "diff"
);
var useSnapshotValueViewer = () => _jotai.useAtom.call(void 0, snapshotValueViewer, useDevtoolsJotaiStoreOptions());

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/components/TreeView.tsx
...
var valueRenderer = (valueAsString, value, styling) => {
  function renderSpan(name, body) {
    return /* @__PURE__ */ React38.default.createElement("span", { key: name, ...styling(["diff", name]) }, body);
  }
  if (Array.isArray(value)) {
    switch (value.length) {
      case 1:
      ...
      case 2:
        return /* @__PURE__ */ React38.default.createElement(React38.default.Fragment, null, renderSpan("diffUpdateFrom", stringifyAndShrink(value[0])), renderSpan("diffUpdateArrow", " => "), renderSpan("diffUpdateTo", stringifyAndShrink(value[1])));
      case 3:
        return renderSpan("diffRemove", stringifyAndShrink(value[0]));
    }
  }
  return /* @__PURE__ */ React38.default.createElement(React38.default.Fragment, null, valueAsString);
};
var prepareDelta = (value) => {
  if (value && value._t === "a") {
    ...
    for (const key5 in value) {
      if (key5 !== "_t") {
        if (key5[0] === "_" && !value[key5.substring(1)]) {
          res[key5.substring(1)] = value[key5];
        } else if (value["_" + key5]) {
          res[key5] = [value["_" + key5][0], value[key5][0]];
        } else if (!value["_" + key5] && key5[0] !== "_") {
          res[key5] = value[key5];
        }
      }
    }
...
var TreeView = (props) => {
  const JSONTreeStyling = useJSONTreeStyling();
  const memoizedValueRenderer = _react.useCallback.call(void 0, 
    (valueAsString, value) => valueRenderer(valueAsString, value, JSONTreeStyling.styling),
    [JSONTreeStyling.styling]
  );
  if (props.diff === STATES_EQUAL_SYMBOL) {
    return /* @__PURE__ */ React38.default.createElement(_core.Code, null, "(states are equal)");
  }
  return /* @__PURE__ */ React38.default.createElement(
    JSONTree,
    {
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/components/SnapshotValue.tsx
var SnapshotValue = (props) => {
  const [snapshotValueViewer2, setSnapshotValueViewer] = useSnapshotValueViewer();
  const handleOnTabChange = _react.useCallback.call(void 0, 
    (value) => {
      if (value) {
        setSnapshotValueViewer(value);
      }
    },
    [setSnapshotValueViewer]
  );
  return /* @__PURE__ */ React38.default.createElement(_core.Box, null, /* @__PURE__ */ React38.default.createElement(_core.Title, { size: "h5", mb: 10 }, "Value"), /* @__PURE__ */ React38.default.createElement(
    _core.Tabs,
    {
      defaultValue: "state",
      keepMounted: false,
      id: "jotai-devtools-time-travel-value-tabs",
      value: snapshotValueViewer2,
      onChange: handleOnTabChange
    },
    /* @__PURE__ */ React38.default.createElement(_core.Tabs.List, null, /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Tab,
      {
        value: "state",
        leftSection: /* @__PURE__ */ React38.default.createElement(IconFileCode, { size: "0.9rem", stroke: "1.75" })
      },
      "State"
    ), /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Tab,
      {
        value: "diff",
        leftSection: /* @__PURE__ */ React38.default.createElement(IconFileDiff, { size: "0.9rem", stroke: "1.75" })
      },
      "Diff"
    )),
    /* @__PURE__ */ React38.default.createElement(_core.Tabs.Panel, { value: "state", pt: "xs" }, /* @__PURE__ */ React38.default.createElement(JSONTree, { data: props.state.displayValues })),
    /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Panel,
      {
        value: "diff",
      ...
      /* @__PURE__ */ React38.default.createElement(TreeView, { diff: props.state.diff })
    )
  ));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/components/DisplaySnapshotDetails/DisplaySnapshotDetails.tsx
var DisplaySnapshotDetails = (props) => {
  return /* @__PURE__ */ React38.default.createElement(_core.Stack, { h: "auto", pb: "sm" }, /* @__PURE__ */ React38.default.createElement(_core.Title, { size: "h3" }, "Snapshot ", props.details.label), /* @__PURE__ */ React38.default.createElement(SnapshotMetaDetails, { timestamp: props.details.timestamp }), /* @__PURE__ */ React38.default.createElement(SnapshotValue, { state: props.details }), /* @__PURE__ */ React38.default.createElement(
    SnapshotActions,
    {
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotDetail/SnapshotDetail.tsx
var messageBoxWrapperStyles2 = {
  position: "relative",
  top: "50%",
  transform: "translateY(-50%)"
};
var loadingOverlayOverlayProps2 = {
  blur: 2,
  backgroundOpacity: 0
};
var SnapshotDetail = React28.memo(() => {
  ...
  if (!selectedSnapshotDetail) {
    return /* @__PURE__ */ React28.createElement(_core.Box, { style: messageBoxWrapperStyles2 }, /* @__PURE__ */ React28.createElement(_core.Text, { w: "100%", ta: "center" }, "Select a snapshot from the left panel to view the details"));
  }
  return /* @__PURE__ */ React28.createElement(
    React28.Suspense,
    {
      fallback: /* @__PURE__ */ React28.createElement(
        _core.LoadingOverlay,
        {
          visible: true,
          overlayProps: loadingOverlayOverlayProps2,
          loaderProps
        }
      )
    },
    /* @__PURE__ */ React28.createElement(DisplaySnapshotDetails, { details: selectedSnapshotDetail })
  );
});
SnapshotDetail.displayName = "SnapshotDetail";

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/SnapshotList.tsx




// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/Header.tsx



// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/ClearHistory.tsx
...
var ClearHistory = () => {
  ...
  return /* @__PURE__ */ React38.default.createElement(
    ...
    /* @__PURE__ */ React38.default.createElement(IconTrashX, { size: 16 })
  );
};
...
var RecordHistory = () => {
  ...
  const label = shouldRecord ? "Stop recording snapshot history" : "Record snapshot history";
  return /* @__PURE__ */ React38.default.createElement(_core.Tooltip, { label, openDelay: 750, withinPortal: false }, /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "outline",
      color: useThemeMode(
    ...
    /* @__PURE__ */ React38.default.createElement(IconPlayerRecordFilled, { size: 18 })
  ));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/SnapshotListNavigation.tsx



// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/atoms.ts



var snapshotHistoryNavigationAtom = _vanilla.atom.call(void 0, 
  (get) => {
    const snapshotHistory = get(filteredSnapshotHistoryAtom);
    const selectedSnapshotId = get(selectedSnapshotIdAtom);
    if (selectedSnapshotId) {
      ...
      return {
        prevId: foundIndex > 0 ? _optionalChain([snapshotHistory, 'access', _29 => _29[foundIndex - 1], 'optionalAccess', _30 => _30.id]) : void 0,
        nextId: foundIndex < snapshotHistory.length - 1 ? _optionalChain([snapshotHistory, 'access', _31 => _31[foundIndex + 1], 'optionalAccess', _32 => _32.id]) : void 0
      };
    }
    return {
      prevId: void 0,
...
var useSnapshotHistoryNavigation = () => {
  const [{ prevId, nextId }, selectSnapshot] = _react2.useAtom.call(void 0, 
    snapshotHistoryNavigationAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const isPreviousPossible = !!prevId;
  const isNextPossible = !!nextId;
  const onPrevious = _react.useCallback.call(void 0, () => {
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/SnapshotListNavigation.tsx
var SnapshotListNavigation = () => {
  const { prev, next } = useSnapshotHistoryNavigation();
  return /* @__PURE__ */ React38.default.createElement(_core.Group, null, /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "default",
      color: useThemeMode("dark", "gray"),
    ...
    /* @__PURE__ */ React38.default.createElement(IconChevronUp, { size: 16 })
  ), /* @__PURE__ */ React38.default.createElement(
    _core.ActionIcon,
    {
      variant: "default",
    ...
    /* @__PURE__ */ React38.default.createElement(IconChevronDown, { size: 16 })
  ));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/SnapshotSearchInput.tsx
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/components/Header.tsx
var Header2 = () => {
  return /* @__PURE__ */ React38.default.createElement(_core.Stack, { className: "internal-jotai-devtools-header-wrapper", gap: "sm" }, /* @__PURE__ */ React38.default.createElement(
    _core.Group,
    {
    ...
    /* @__PURE__ */ React38.default.createElement(_core.Group, null, /* @__PURE__ */ React38.default.createElement(RecordHistory, null), /* @__PURE__ */ React38.default.createElement(ClearHistory, null)),
    /* @__PURE__ */ React38.default.createElement(SnapshotListNavigation, null)
  ), /* @__PURE__ */ React38.default.createElement(SnapshotSearchInput, null));
};

// src/DevTools/Extension/components/Shell/components/TimeTravel/components/SnapshotList/SnapshotList.tsx
var snapshotHistoryListWrapperStyle = {
  overflow: "auto",
  marginTop: 10
};
var SnapshotList = () => {
  ...
  const { cancel, scrollIntoView, targetRef, scrollableRef } = _hooks.useScrollIntoView.call(void 0, {
    cancelable: true,
    isList: true,
    duration: 200,
    onScrollFinish: () => {
  ...
  const handleOnClick = _react.useCallback.call(void 0, 
    (id) => {
      if (typeof id !== "string") {
  ...
  const snapshotHistoryList = _react.useMemo.call(void 0, 
  ...
  return /* @__PURE__ */ React38.default.createElement(React38.default.Fragment, null, /* @__PURE__ */ React38.default.createElement(Header2, null), /* @__PURE__ */ React38.default.createElement(
    _core.Box,
    {
    ...
    snapshotHistoryList
  ), noResultsFound && /* @__PURE__ */ React38.default.createElement(_core.Group, { mt: 20, justify: "center", gap: 6 }, /* @__PURE__ */ React38.default.createElement(IconAlertCircle, { size: 16 }), /* @__PURE__ */ React38.default.createElement(
    _core.Text,
    {
      fz: "sm",
      ml: 0,
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/TimeTravel.tsx
var panelStyles2 = { overflow: "auto" };
var panelGroupStyles = { height: "calc(100% - 56px)" };
var TimeTravel = React35.memo(() => {
  return /* @__PURE__ */ React35.createElement(React35.Fragment, null, /* @__PURE__ */ React35.createElement(
    ...
    /* @__PURE__ */ React35.createElement(
      ...
      /* @__PURE__ */ React35.createElement(
        ...
        /* @__PURE__ */ React35.createElement(SnapshotList, null)
      )
    ),
    /* @__PURE__ */ React35.createElement(PanelResizeHandle, null),
    /* @__PURE__ */ React35.createElement(
      _reactresizablepanels.Panel,
      {
        defaultSize: 55,
      ...
      /* @__PURE__ */ React35.createElement(_core.Flex, { p: 10, pl: 0, h: "100%", direction: "column", pos: "relative" }, /* @__PURE__ */ React35.createElement(SnapshotDetail, null))
    )
  ), /* @__PURE__ */ React35.createElement(PlayBar, null));
});

// src/DevTools/Extension/components/Shell/Shell.tsx
var Shell = () => {
  const [selectedShellTab2, setSelectedShellTab] = useSelectedShellTab();
  const shellRef = _react.useRef.call(void 0, null);
  const { height } = _react2.useAtomValue.call(void 0, 
    shellStylesAtom,
    useDevtoolsJotaiStoreOptions()
  );
  const handleOnTabChange = (value) => setSelectedShellTab(value);
  return /* @__PURE__ */ React38.default.createElement(
    _core.Tabs,
    {
      keepMounted: false,
      variant: "default",
      defaultValue: "atom-viewer" /* AtomViewer */,
      h: height,
      mah: shellStyleDefaults.maxHeight,
      ref: shellRef,
      className: _clsx2.default.call(void 0, "internal-jotai-devtools-shell", "jotai-devtools-shell"),
      "data-testid": "jotai-devtools-shell",
      id: "jotai-devtools-shell",
      value: selectedShellTab2,
      onChange: handleOnTabChange,
      color: "dark"
    },
    /* @__PURE__ */ React38.default.createElement(ShellResizeBar, { shellRef }),
    /* @__PURE__ */ React38.default.createElement(Header, null),
    /* @__PURE__ */ React38.default.createElement(ErrorBoundary, null, /* @__PURE__ */ React38.default.createElement(TabsHeader, null), /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Panel,
      {
        value: "atom-viewer" /* AtomViewer */,
        h: "100%",
      ...
      /* @__PURE__ */ React38.default.createElement(AtomViewer, null)
    ), /* @__PURE__ */ React38.default.createElement(
      _core.Tabs.Panel,
      {
        value: "time-travel" /* TimeTravel */,
      ...
      /* @__PURE__ */ React38.default.createElement(TimeTravel, null)
    ))
  );
};
...
// src/DevTools/utils/create-timestamp.ts
var formatTimeToTimeStamp = (time) => new Date(time).toLocaleString("en-US", {
  hour: "numeric",
  minute: "numeric",
  second: "numeric",
...
// src/DevTools/Extension/components/Shell/components/TimeTravel/useSyncSnapshotHistory.ts
var generateShortId = () => Date.now().toString(36).substring(5) + Math.random().toString(36).substring(8);
var inspectPromise = async (promise) => {
...
function useSyncSnapshotHistory() {
  const userStore2 = useUserStore();
  ...
  const { snapshotHistoryLimit, shouldShowPrivateAtoms } = useDevToolsOptionsValue();
  _react.useEffect.call(void 0, () => {
    if (!_chunkTOJPDLRZcjsjs.isDevToolsStore.call(void 0, userStore2)) return;
    const addToHistoryStack = (nextSnapshot, displayValues) => {
      setHistory((prev) => {
        const prevSnapshot = prev[prev.length - 1];
        const nextSnapshotHistoryItem = {
          id: generateShortId(),
          value: nextSnapshot,
          displayValues,
          label: (_optionalChain([prevSnapshot, 'optionalAccess', _33 => _33.label]) || 0) + 1,
          isHidden: false,
        ...
        if (nextSnapshotHistory.length >= snapshotHistoryLimit && nextSnapshotHistory[0]) {
    ...
    const collectValues = async () => {
      ...
      for (const atom8 of userStore2.getMountedAtoms() || []) {
        const atomState = userStore2.getAtomState(atom8);
        if (atomState) {
          if ("v" in atomState) {
            values.set(atom8, atomState.v);
            if (!atom8.debugPrivate) {
              if (atomState.v instanceof Promise) {
                const promiseResult = await inspectPromise(atomState.v);
                displayValues[atomToPrintable(atom8)] = promiseResult;
              } else {
                displayValues[atomToPrintable(atom8)] = atomState.v;
              }
            }
          }
        }
        const mounted = userStore2.getMountedAtomState(atom8);
        if (mounted) {
          dependents.set(atom8, mounted.t);
        }
      }
      addToHistoryStack({ values, dependents }, displayValues);
    };
    const cb = async (action) => {
      const isWrite = action.type === "set" || action.type === "async-get";
      if (isWrite && shouldRecordSnapshotHistory && !store.get(isTimeTravelingAtom)) {
        await collectValues();
      }
    };
    const unsub = userStore2.subscribeStore(cb);
    return unsub;
  }, [
    store,
    userStore2,
...
// src/DevTools/Extension/Extension.tsx
var ShellTriggerButton = React37.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React37.createElement(
    _core.ActionIcon,
    {
      ...
      left: _optionalChain([position, 'optionalAccess', _34 => _34.includes, 'call', _35 => _35("left")]) ? "0.2rem" : "unset",
      right: _optionalChain([position, 'optionalAccess', _36 => _36.includes, 'call', _37 => _37("right")]) ? "0.2rem" : "unset",
      top: _optionalChain([position, 'optionalAccess', _38 => _38.includes, 'call', _39 => _39("top")]) ? "0.2rem" : "unset",
      bottom: _optionalChain([position, 'optionalAccess', _40 => _40.includes, 'call', _41 => _41("bottom")]) ? "0.2rem" : "unset",
      className: _clsx2.default.call(void 0, 
        "internal-jotai-devtools-trigger-button",
        "jotai-devtools-trigger-button"
      )
    },
    /* @__PURE__ */ React37.createElement("img", { src: logo, alt: "Jotai Mascot" })
  );
});
var Extension = ({
  isInitialOpen = false,
  ...
  const [isShellOpen, setIsShellOpen] = _react2.useAtom.call(void 0, 
    isShellOpenAtom,
    useDevtoolsJotaiStoreOptions()
  );
  ...
  return /* @__PURE__ */ React37.createElement(React37.Fragment, null, isShellOpen ? /* @__PURE__ */ React37.createElement(Shell, null) : /* @__PURE__ */ React37.createElement(ShellTriggerButton, { position }));
};

// src/DevTools/DevTools.tsx
var getRootElement = () => {
  const value = typeof window === "undefined" ? void 0 : document.getElementById("jotai-devtools-root") || void 0;
  return value;
};
var colorSchemeManager = _core.localStorageColorSchemeManager.call(void 0, {
  key: "jotai-devtools-color-scheme"
});
var theme = _core.createTheme.call(void 0, {
  primaryColor: "dark",
...
var DevToolsMain = ({
  ...
  React38.useEffect(() => {
    setDevToolsOptions(options2);
  }, [setDevToolsOptions, options2]);
  const conditionalProps = React38.useMemo(() => {
    if (typeof userColorScheme === "string") {
      return { forceColorScheme: userColorScheme };
    }
    return {};
  }, [userColorScheme]);
  return /* @__PURE__ */ React38.createElement(React38.StrictMode, null, /* @__PURE__ */ React38.createElement("span", { id: "jotai-devtools-root" }, /* @__PURE__ */ React38.createElement(
    _core.MantineProvider,
    {
      theme,
      colorSchemeManager,
...
var DevToolsProvider = ({ children }) => {
  const internalStoreRef = React38.useRef();
  if (!internalStoreRef.current) {
    internalStoreRef.current = _vanilla.createStore.call(void 0, );
  }
  return /* @__PURE__ */ React38.createElement(InternalDevToolsContext.Provider, { value: internalStoreRef.current }, children);
};
var InternalDevTools = (props) => {
  if (process.env.NODE_ENV !== "production") {
    ...
    return /* @__PURE__ */ React38.createElement(DevToolsProvider, null, /* @__PURE__ */ React38.createElement(DevToolsMain, { ...props }));
  }
...
exports.InternalDevTools = InternalDevTools;
